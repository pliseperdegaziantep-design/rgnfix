...
const products = [
  {
    title: "Pencere Akordiyon Sineklik – Antrasit",
    shortTitle: "Antrasit Pencere Sineklik",
    image: "/sineklik/pencere-antrasit.svg",
    description: "Antrasit PVC ve alüminyum pencereler için ölçüye özel üretilen, yana toplanan pileli akordiyon sineklik. İnce fiber tülü havalandırmayı korurken sinek ve böceklerin içeri girmesini engeller.",
    keywords: "antrasit pencere sineklik, akordiyon sineklik, plise sineklik",
    icon: Grid2X2,
  },
  {
    title: "Pencere Akordiyon Sineklik – Beyaz",
    shortTitle: "Beyaz Pencere Sineklik",
    image: "/sineklik/pencere-beyaz.svg",
    description: "Beyaz PVC pencerelerle uyumlu, şık ve kullanışlı pencere akordiyon sineklik modeli. Özel ölçü üretim, kolay kullanım ve temiz görünüm sunar.",
    keywords: "beyaz pencere sineklik, ölçüye özel sineklik, fiber tül sineklik",
    icon: Grid2X2,
  },
  {
    title: "Kapı Akordiyon Sineklik – Antrasit",
    shortTitle: "Antrasit Kapı Sineklik",
    image: "/sineklik/kapi-antrasit.svg",
    description: "Balkon kapısı, teras kapısı ve sürgülü geçişler için sağlam antrasit akordiyon kapı sinekliği. Geniş açıklıklarda rahat geçiş sağlar ve kullanılmadığında yana toplanır.",
    keywords: "kapı sineklik, balkon kapısı sineklik, antrasit plise sineklik",
    icon: DoorOpen,
  },
  {
    title: "Kapı Akordiyon Sineklik – Beyaz",
    shortTitle: "Beyaz Kapı Sineklik",
    image: "/sineklik/kapi-beyaz.svg",
    description: "Beyaz balkon ve teras kapıları için ölçüye özel akordiyon sineklik. Dayanıklı ray sistemi, fiber tül ve kolay açılıp kapanan yapısıyla günlük kullanım için idealdir.",
    keywords: "beyaz kapı sineklik, teras kapısı sineklik, demonte sineklik",
    icon: DoorOpen,
  },
];
...
export default function InsectScreen() {
  useEffect(() => {
    document.title = "Akordiyon Sineklik Fiyatları | Pencere ve Kapı Sineklik – RGNFIX";
    const description = "Pencere ve kapılar için ölçüye özel akordiyon sineklik. Beyaz ve antrasit profil, fiber tül, demonte gönderim ve Türkiye geneli ölçü desteği.";
    ...
    <div className="container max-w-6xl py-10 sm:py-14">
      <section className="overflow-hidden rounded-3xl border bg-gradient-to-br from-primary/10 via-background to-secondary/10 p-7 sm:p-12">
        <div className="max-w-3xl">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-background/80 px-4 py-2 text-sm font-medium text-primary shadow-sm">
            <Sparkles className="h-4 w-4" /> Ölçüye özel pencere ve kapı sineklik
          </div>
          <h1 className="text-3xl font-bold leading-tight sm:text-5xl">Akordiyon Sineklik Modelleri ve Fiyat Desteği</h1>
          <p className="mt-4 max-w-2xl text-sm leading-7 text-muted-foreground sm:text-base">
            Evinizi havalandırırken sinek, sivrisinek ve böceklerden korunmak için pencere ve kapınıza özel üretilen akordiyon sineklik çözümlerini inceleyin. Fiber tüllü plise sineklikler, kullanılmadığında yana toplanır ve doğramanızla uyumlu temiz bir görünüm sağlar.
          </p>
          ...
          <Button asChild className="mt-7 h-12 gap-2 px-6">
            <a href="https://wa.me/905300288903?text=Merhaba%2C%20pencere%20veya%20kap%C4%B1%20akordiyon%20sineklik%20i%C3%A7in%20%C3%B6l%C3%A7%C3%BC%20ve%20fiyat%20deste%C4%9Fi%20almak%20istiyorum." target="_blank" rel="noreferrer"><MessageCircle className="h-4 w-4" /> Anlık Fiyat Al</a>
          </Button>
        </div>
      </section>
      ...
      <section className="mt-10" aria-labelledby="pencere-sineklik-baslik">
        <div className="mb-5">
          ...
          <h2 id="pencere-sineklik-baslik" className="mt-1 text-2xl font-bold sm:text-3xl">Pencere Akordiyon Sineklik Örnekleri</h2>
          <p className="mt-2 max-w-3xl text-sm leading-6 text-muted-foreground">PVC, alüminyum ve standart pencere doğramaları için beyaz veya antrasit profilli pencere sineklik seçenekleri.</p>
        </div>
      ...
      <section className="mt-12" aria-labelledby="kapi-sineklik-baslik">
        <div className="mb-5">
          ...
          <h2 id="kapi-sineklik-baslik" className="mt-1 text-2xl font-bold sm:text-3xl">Kapı Akordiyon Sineklik Örnekleri</h2>
          <p className="mt-2 max-w-3xl text-sm leading-6 text-muted-foreground">Balkon, teras ve sürgülü kapılara uygun, rahat geçiş sağlayan ölçüye özel kapı sineklik sistemleri.</p>
        </div>
        <div className="grid gap-5 md:grid-cols-2">
      ...
      <Card className="mt-12 border-primary/20 bg-primary/5">
        <CardContent className="grid gap-7 p-6 sm:p-8 lg:grid-cols-2 lg:items-center">
          <div>
            <p className="text-sm font-semibold text-primary">NEDEN AKORDİYON SİNEKLİK?</p>
      ...
      <section className="mt-12 rounded-3xl border p-6 sm:p-9">
        <h2 className="text-2xl font-bold">Akordiyon sineklik ölçüsü nasıl alınır?</h2>
        ...
        <div className="mt-5 flex flex-col gap-3 sm:flex-row">
          <Button asChild className="gap-2"><a href="https://wa.me/905300288903?text=Merhaba%2C%20akordiyon%20sineklik%20%C3%B6l%C3%A7%C3%BCs%C3%BC%20ve%20fiyat%C4%B1%20i%C3%A7in%20destek%20istiyorum." target="_blank" rel="noreferrer"><MessageCircle className="h-4 w-4" /> Ölçü ve Fiyat Desteği</a></Button>
      ...
      <div className="mt-10 text-sm leading-7 text-muted-foreground">
        <h2 className="text-xl font-bold text-foreground">Gaziantep ve Türkiye Geneli Sineklik Çözümleri</h2>
        <p className="mt-2">RGNFIX; Gaziantep akordiyon sineklik, pencere sineklik, kapı sineklik, plise sineklik ve demonte sineklik aramalarında ihtiyaca uygun ürün seçimini kolaylaştırır. Gaziantep içi uygulama uygunluğuna göre montaj desteği, şehir dışına ise ölçüye özel hazırlanmış ürünlerin güvenli gönderimi sağlanır.</p>
      </div>
    </div>
  );
}
